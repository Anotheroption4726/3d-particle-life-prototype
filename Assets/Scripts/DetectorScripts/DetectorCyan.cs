...
public class DetectorCyan : DetectorMAIN
{
    //
    ...
    void OnTriggerStay(Collider col)
    {
        ...
        if (col.GetComponent<ParticleScript>() != null && col.GetComponent<ParticleScript>().pType != ParticleScript.ParticleType.TYPE_4)
        {
